...
use common\widgets\InfoBox;

$this->title = 'Widgets';
$this->params['breadcrumbs'][] = $this->title;
$this->params['description'] = 'Common widgets';
...
$boxes = [
    [
        ...
        'overlay' => Html::icon('refresh', ['class' => 'fa-spin']),
    ],
    [
...
<?php Box::begin([
    ...
    <div class="site-about">
        <p>You can find the code for these widgets in the folder:</p>
        <code><?= \Yii::getAlias('@common/widgets') ?></code>
    </div>
<?php Box::end() ?>
