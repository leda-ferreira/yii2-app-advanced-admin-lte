 ...
 * @property string $view_Path The controller view path. This property is read-only.
 *
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'controllerClass' => 'This is the name of the controller class to be generated. You should
                provide a fully qualified namespaced class (e.g. <code>common\controllers\PostController</code>),
    ...
    public function getNameAttribute()
    {
        foreach ($this->getColumnNames() as $name) {
            if (!strcasecmp($name, 'name') ||
                ...
                !strcasecmp($name, 'nome') ||
                !strcasecmp($name, 'titulo') ||
                !strcasecmp($name, 'assunto')
            ) {
                return $name;
            }
        }
